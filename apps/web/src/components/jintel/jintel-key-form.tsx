    ...
    <div className={cn('space-y-3', className)}>
      <div className="relative">
        <input
          ...
          placeholder="Enter your Jintel API key"
          className="w-full rounded-lg border border-border bg-bg-secondary px-3 py-2 pr-10 text-sm text-text-primary placeholder:text-text-muted focus:border-accent-primary focus:outline-none"
          onKeyDown={(e) => {
      ...
      <Button variant="primary" size="sm" onClick={handleValidate} disabled={fetching || !apiKey.trim()}>
